defmodule Membrane.Element.FFmpeg.H264.MixProject do
  ...
  defp deps do
    [
      ...
      {:membrane_core,
       github: "membraneframework/membrane-core", branch: "redemands", override: true},
      {:membrane_common_c,
       github: "membraneframework/membrane-common-c",
       branch: "feature/shmex_unifex",
       override: true},
      {:membrane_caps_video_h264,
       github: "membraneframework/membrane-caps-video-h264", branch: "develop"},
      {:membrane_caps_video_raw,
       github: "membraneframework/membrane-caps-video-raw", branch: "develop"},
      {:bundlex, "~> 0.1.3"},
      {:unifex, "~> 0.1.0",
       github: "membraneframework/unifex", branch: "misc-ffmpeg-h264", override: true},
